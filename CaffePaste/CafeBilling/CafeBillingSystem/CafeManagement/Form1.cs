...
namespace CafeManagement
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string query = "INSERT INTO pesan1(Latte,Espresso,Mocha,Vale,Cappucino,Cold,Milk,Chinese,Coffee,Valvet,Blackforest,Boston,Logos,Kilburn,Cheese,Rainbow)VALUES('"+ this.txtLatte.Text + "','"+ this.txtEspresso.Text + "' , '"+ this.txtMocha.Text + "'," +
